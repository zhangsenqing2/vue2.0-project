  ...
  <div id="container">
    <aside class="sidebar">
      ...
      <div class="sidebox hot">
        ...
        <div class="figure">
          <figure>
            <img src="../../assets/img/hot1.jpg" alt="曼谷-芭提雅6日游">
            <figcaption>曼谷-芭提雅6日游</figcaption>
          </figure>
          <figure>
            <img src="../../assets/img/hot2.jpg" alt="马尔代夫双鱼6日游">
            <figcaption>马尔代夫双鱼6日游</figcaption>
          </figure>
          <figure>
            <img src="../../assets/img/hot3.jpg" alt="海南双飞5日游">
            <figcaption>海南双飞5日游</figcaption>
          </figure>
          <figure>
            <img src="../../assets/img/hot4.jpg" alt="富山大阪东京8日游">
            <figcaption>富山大阪东京8日游</figcaption>
          </figure>
          <figure>
            <img src="../../assets/img/hot5.jpg" alt="法瑞意德12日游">
            <figcaption>法瑞意德12日游</figcaption>
          </figure>
          <figure>
            <img src="../../assets/img/hot6.jpg" alt="巴厘岛6日半游">
            <figcaption>巴厘岛6日半游</figcaption>
          </figure>
          <figure>
            <img src="../../assets/img/hot7.jpg" alt="塞舌尔迪拜9日游">
            <figcaption>塞舌尔迪拜9日游</figcaption>
          </figure>
          <figure>
            <img src="../../assets/img/hot8.jpg" alt="花样土耳其10日游">
    ...
    <div class="list information">
      ...
      <figure class="tour">
        <img src="../../assets/img/tour1.jpg" alt="曼谷-芭提雅6日游">
        <figcaption>
          <article>
            <header>
              <hgroup>
      ...
      <figure class="tour">
        <img src="../../assets/img/tour2.jpg" alt="马尔代夫6日自助游">
        <figcaption>
          <article>
            <header>
              <hgroup>
      ...
      <figure class="tour">
        <img src="../../assets/img/tour3.jpg" alt="海南双飞5日游">
        <figcaption>
          <article>
            <header>
              <hgroup>
      ...
      <figure class="tour">
        <img src="../../assets/img/tour4.jpg" alt="富山-大阪-东京8日游">
        <figcaption>
          <article>
            <header>
              <hgroup>
      ...
      <figure class="tour">
        <img src="../../assets/img/tour5.jpg" alt="法瑞意德12日游">
        <figcaption>
          <article>
            <header>
              <hgroup>
      ...
      <figure class="tour">
        <img src="../../assets/img/tour6.jpg" alt="巴厘岛6日半自助游">
        <figcaption>
          <article>
            <header>
              <hgroup>
      ...
      <figure class="tour">
        <img src="../../assets/img/tour7.jpg" alt="塞舌尔迪拜9日自助游">
        <figcaption>
          <article>
            <header>
              <hgroup>
      ...
      <figure class="tour">
        <img src="../../assets/img/tour8.jpg" alt="花样姐姐土耳其9日游">
        <figcaption>
          <article>
            <header>
              <hgroup>
      ...
      <figure class="tour">
        <img src="../../assets/img/tour9.jpg" alt="大阪-京都-箱根双飞6日游">
        <figcaption>
          <article>
            <header>
              <hgroup>
